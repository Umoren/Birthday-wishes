...
const BirthdayPage = () => {
    ...
    const fetchBirthday = async () => {
        try {
            const res = await fetch(`http://localhost:5000/api/birthday/${birthdayId}`);
    ...
    const fetchAllWishes = async () => {
        try {
            const res = await fetch(`http://localhost:5000/api/wish/${birthdayId}`);
            const data = await res.json();
    ...
    const handleWishSubmit = async (e) => {
        ...
        try {
            const res = await fetch("http://localhost:5000/api/wish", {
                method: "POST",
                        ...
                        <div className="relative">
                            {birthday.imageUrl && (
                                <>
                                    ...
                                    <img
                                        src={birthday.imageUrl || "/placeholder.svg"}
                                        alt=""
                            ...
                            <div
                                className={`p-6 ${birthday.imageUrl ? "absolute bottom-0 text-white" : ""
                                    }`}
                            >
                                            ...
                                            <div className="flex items-start gap-3">
                                                <div className="flex-shrink-0">
                                                    <div className="w-10 h-10 rounded-full bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center">
                                                        <FiHeart className="h-5 w-5 text-purple-500" />
                                                    </div>
                                                </div>
